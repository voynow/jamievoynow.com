...
const Portfolio = () => {
    ...
    return (
        <div className="bg-white min-h-screen flex flex-col items-center py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-6 flex flex-wrap justify-center items-start gap-6">
                {portfolio.map((project, index) => (
                    <div key={index} className="w-full sm:w-64 bg-gray-100 rounded-xl p-4 shadow-lg transform transition duration-200 hover:scale-105">
